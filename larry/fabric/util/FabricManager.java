...
public class FabricManager {
    ...
    private FabricConfig getConfig() {
        ...
        config.setChaincode(getChaincode("mychannel", "mychannel",
                "github.com/hyperledger/aberic/chaincode/go/chaincode_example02", "1.0"));
    ...
    private Orderers getOrderers() {
        ...
        orderer.addOrderer("orderer.example.com", "grpc://192.168.1.110:7050");
...
//        orderer.addOrderer("orderer2.example.com", "grpc://x.x.x.xxx:7050");
    ...
    private Peers getPeers() {
        ...
        peers.addPeer("peer0.org1.example.com", "peer0.org1.example.com",
                "grpc://192.168.1.110:7051", "grpc://192.168.1.110:7053", "http://192.168.1.110:7054");
        return peers;
    }
  ...
  /*public static void main(String[] args) {
        try {
            ...
            arguments[4] = "1";
            arguments[5] = "5";
             Map<String, String> query = manager.query("register", arguments);
            System.out.println(query.get("data"));
